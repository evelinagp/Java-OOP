package ReflectionAndAnnotation7.Lab.ReflectionAndAnnotation_HighQualityMistakesLab03;
...
public class Main {
    ...
    public static void main(String[] args) throws ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
        ...
        Class<?> clazz = Class.forName("ReflectionAndAnnotation7.Lab.ReflectionAndAnnotation_HighQualityMistakesLab03.Reflection");
        ...
        fields.addAll(Arrays.stream(clazz.getDeclaredFields()).filter(f -> !Modifier.isPrivate(f.getModifiers()))
