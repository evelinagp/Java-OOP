package WorkingWithAbstraction_PointInRectangleLab02;
...
public class Main {
    public static void main(String[] args) {
        ...
        Rectangle rectangle = new Rectangle(new Point2D(coordinates[0], coordinates[1]), new Point2D(coordinates[2], coordinates[3]));
