package LoggerSOLIDEx01.engine;

import LoggerSOLIDEx01.api.Appender;
import LoggerSOLIDEx01.api.Layout;
import LoggerSOLIDEx01.api.Logger;
import LoggerSOLIDEx01.enums.ReportLevel;
import LoggerSOLIDEx01.model.loggers.MessageLogger;
...
public class Engine implements Runnable {
    ...
    private Appender getApender(String appenderType, Layout layout) throws ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
        Class<?> clazz = Class.forName("LoggerSOLIDEx01.model.appenders." + appenderType);
    ...
    private Layout getLayout(String layoutType) throws ClassNotFoundException, NoSuchMethodException, IllegalAccessException, InvocationTargetException, InstantiationException {
        Class<?> clazz = Class.forName("LoggerSOLIDEx01.model.layouts." + layoutType);
